...
async function testLocalChain() {
  ...
  try {
    ...
    if (!manager.isEnabled()) {
      console.log('❌ Local Chain is not enabled. Set LOCAL_CHAIN_ENABLED=true in your .env file');
      return;
    }
    ...
    console.log('✅ Contract invocation result:', JSON.stringify(contractResult, null, 2));
